...
import { exportProposalToPdf, exportProposalToExcel, exportProposalToMarkdown, type ExportSection } from "../lib/exportUtils";
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      exportProposalToMarkdown(project, exportSections);
                    }}
                  >
                    <Download className="w-3.5 h-3.5" />
                    MD
